...
from src.repository.instance import roomRepository, incidentRepository, playerRepository, gameRepository
...
app.state.playerRepository = playerRepository
app.state.gameRepository = gameRepository
